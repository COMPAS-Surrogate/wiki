...
<figure><img src="../.gitbook/assets/fsb_bias_vs_t.png" alt=""><figcaption><p>Likelihood bias vs t. Dotted lines mark where our COMPAS runs sit for a 1 yr (~750 event) mock.</p></figcaption></figure>
...
* **0.45% of merging BBHs carry 50% of the total detection rate** — identical in both runs (5M and 32M runs)
* The \~1.5% efficiency is the **same in both runs**, so it is structural. More binaries will not improve it i think
...
<figure><img src="../.gitbook/assets/fsb_weight_concentration.png" alt=""><figcaption><p>Left: a tiny fraction of binaries carries the whole rate. Right: effective binaries backing each McZ grid bin.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/fsb_which_analysis_safe.png" alt=""><figcaption><p>Bias vs number of observed events, for each COMPAS run size.</p></figcaption></figure>
